...
// Font: Determination-light.png

#include "gbs_types.h"

static const UBYTE font_determination_light_table[] = {
    ...
    0x5F, 0x6D, 0x6E, 0x6F, 0x02, 0x70, 0x71, 0x72, 0x73, 0x74, 0x69, 0x75, 0x76, 0x5F, 0x6C, 0x77,
    0x5F, 0x78, 0x79, 0x7A, 0x7B, 0x7C, 0x7D, 0x7E, 0x7F, 0x80, 0x81, 0x82, 0x83, 0x5F, 0x84, 0x85,
    0x86, 0x87, 0x88, 0x89, 0x8A, 0x8B, 0x8C, 0x8D, 0x8E, 0x8F, 0x86, 0x90, 0x5F, 0x5F, 0x5F, 0x91,
    ...
    0xB2, 0xB3, 0xB4, 0xB5, 0xB6, 0xB7, 0xB8, 0xB9, 0xBA, 0xBB, 0xBC, 0xBD, 0x9E, 0x9F, 0xA0, 0xA1,
    0xBE, 0xBF, 0xC0, 0xC1, 0xC2, 0xC3, 0xC4, 0xC5, 0xC6, 0xC7, 0xC8, 0xC9, 0xCA, 0xCB, 0xCC, 0xCD
};

static const UBYTE font_determination_light_bitmaps[] = {
    0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
    0x00, 0x00, 0x30, 0x30, 0x78, 0x78, 0x78, 0x78, 0x30, 0x30, 0x30, 0x30, 0x00, 0x00, 0x30, 0x30,
    ...
    0x00, 0x00, 0x0C, 0x0C, 0x18, 0x18, 0x18, 0x18, 0x18, 0x18, 0x18, 0x18, 0x18, 0x18, 0x0C, 0x0C,
    0x00, 0x00, 0x30, 0x30, 0x18, 0x18, 0x18, 0x18, 0x18, 0x18, 0x18, 0x18, 0x18, 0x18, 0x30, 0x30,
    0x00, 0x00, 0x00, 0x00, 0x6C, 0x6C, 0x38, 0x38, 0xFE, 0xFE, 0x38, 0x38, 0x6C, 0x6C, 0x00, 0x00,
    ...
    ,
    ...
    ,
    ...
    ,
    ...
    ,
...
BANKREF(font_determination_light)
const font_desc_t font_determination_light = {
    FONT_RECODE,
    0xFF,
    font_determination_light_table,
    NULL,
    font_determination_light_bitmaps
};
